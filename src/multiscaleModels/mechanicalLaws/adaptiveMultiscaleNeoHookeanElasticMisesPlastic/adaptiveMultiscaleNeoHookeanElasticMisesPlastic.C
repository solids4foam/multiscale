...
#include "adaptiveMultiscaleNeoHookeanElasticMisesPlastic.H"
...
namespace Foam
{
    defineTypeNameAndDebug(adaptiveMultiscaleNeoHookeanElasticMisesPlastic, 0);
    addToRunTimeSelectionTable
    (
        mechanicalLaw, adaptiveMultiscaleNeoHookeanElasticMisesPlastic, nonLinGeomMechLaw
    );

// * * * * * * * * * * * * * * Static Members  * * * * * * * * * * * * * * * //

    // Tolerance for Newton loop
    scalar adaptiveMultiscaleNeoHookeanElasticMisesPlastic::LoopTol_ = 1e-8;

    // Maximum number of iterations for Newton loop
    label adaptiveMultiscaleNeoHookeanElasticMisesPlastic::MaxNewtonIter_ = 200;

    // finiteDiff is the delta for finite difference differentiation
    scalar adaptiveMultiscaleNeoHookeanElasticMisesPlastic::finiteDiff_ = 0.25e-6;

    // Store sqrt(2/3) as we use it often
    scalar adaptiveMultiscaleNeoHookeanElasticMisesPlastic::sqrtTwoOverThree_ = ::sqrt(2.0/3.0);
...
void Foam::adaptiveMultiscaleNeoHookeanElasticMisesPlastic::makeRelF()
{
    if (relFPtr_)
    {
        FatalErrorIn("void Foam::adaptiveMultiscaleNeoHookeanElasticMisesPlastic::makeRelF()")
...
Foam::volTensorField& Foam::adaptiveMultiscaleNeoHookeanElasticMisesPlastic::relF()
{
    if (!relFPtr_)
    {
        makeRelF();
...
void Foam::adaptiveMultiscaleNeoHookeanElasticMisesPlastic::makeRelFf()
{
    if (relFfPtr_)
    {
        FatalErrorIn("void Foam::multiscaleNeoHookeanElasticMisesPlastic::makeRelFf()")
            << "pointer already set" << abort(FatalError);
    }
...
Foam::surfaceTensorField& Foam::adaptiveMultiscaleNeoHookeanElasticMisesPlastic::relFf()
{
    if (!relFfPtr_)
    {
        makeRelFf();
...
void Foam::adaptiveMultiscaleNeoHookeanElasticMisesPlastic::makeJ()
{
    if (JPtr_)
    {
        FatalErrorIn("void Foam::adaptiveMultiscaleNeoHookeanElasticMisesPlastic::makeJ()")
            << "pointer already set" << abort(FatalError);
    }
...
Foam::volScalarField& Foam::adaptiveMultiscaleNeoHookeanElasticMisesPlastic::J()
{
    if (!JPtr_)
    {
        makeJ();
...
void Foam::adaptiveMultiscaleNeoHookeanElasticMisesPlastic::makeJf()
{
    if (JfPtr_)
    {
        FatalErrorIn("void Foam::adaptiveMultiscaleNeoHookeanElasticMisesPlastic::makeJf()")
            << "pointer already set" << abort(FatalError);
    }
...
Foam::surfaceScalarField& Foam::adaptiveMultiscaleNeoHookeanElasticMisesPlastic::Jf()
{
    if (!JfPtr_)
    {
        makeJf();
...
void Foam::adaptiveMultiscaleNeoHookeanElasticMisesPlastic::makeF()
{
    if (FPtr_)
    {
        FatalErrorIn("void Foam::adaptiveMultiscaleNeoHookeanElasticMisesPlastic::makeF()")
            << "pointer already set" << abort(FatalError);
    }
...
Foam::volTensorField& Foam::adaptiveMultiscaleNeoHookeanElasticMisesPlastic::F()
{
    if (!FPtr_)
    {
        makeF();
...
void Foam::adaptiveMultiscaleNeoHookeanElasticMisesPlastic::makeFf()
{
    if (FfPtr_)
    {
        FatalErrorIn("void Foam::adaptiveMultiscaleNeoHookeanElasticMisesPlastic::makeFf()")
            << "pointer already set" << abort(FatalError);
    }
...
Foam::surfaceTensorField& Foam::adaptiveMultiscaleNeoHookeanElasticMisesPlastic::Ff()
{
    if (!FfPtr_)
    {
        makeFf();
...
Foam::scalar Foam::adaptiveMultiscaleNeoHookeanElasticMisesPlastic::curYieldStress
(
...
Foam::scalar Foam::adaptiveMultiscaleNeoHookeanElasticMisesPlastic::yieldFunction
(
...
void Foam::adaptiveMultiscaleNeoHookeanElasticMisesPlastic::newtonLoop
(
...
) const
{
    ...
    do
    {
        ...
        if (i == MaxNewtonIter_)
        {
            WarningIn("adaptiveMultiscaleNeoHookeanElasticMisesPlastic::newtonLoop()")
...
Foam::tmp<Foam::volScalarField> Foam::adaptiveMultiscaleNeoHookeanElasticMisesPlastic::Ibar
(
...
Foam::tmp<Foam::surfaceScalarField> Foam::adaptiveMultiscaleNeoHookeanElasticMisesPlastic::Ibar
(
...
Foam::adaptiveMultiscaleNeoHookeanElasticMisesPlastic::adaptiveMultiscaleNeoHookeanElasticMisesPlastic
(
    const word& name,
    const fvMesh& mesh,
    ...
    )
{
    ...
    else
    {
        FatalErrorIn
        (
            "adaptiveMultiscalNeoHookeanElasticMisesPlastic::adaptiveMultiscalNeoHookeanElasticMisesPlastic::()"
...
Foam::tmp<Foam::volScalarField> Foam::adaptiveMultiscaleNeoHookeanElasticMisesPlastic::rho() const
{
...
Foam::adaptiveMultiscaleNeoHookeanElasticMisesPlastic::impK() const
{
...
void Foam::adaptiveMultiscaleNeoHookeanElasticMisesPlastic::correct(volSymmTensorField& sigma)
{
...
void Foam::adaptiveMultiscaleNeoHookeanElasticMisesPlastic::correct(surfaceSymmTensorField& sigma)
{
    // Check if the mathematical model is in total or updated Lagrangian form
    if (nonLinGeom() == nonLinearGeometry::UPDATED_LAGRANGIAN)
    {
...
Foam::scalar Foam::adaptiveMultiscaleNeoHookeanElasticMisesPlastic::residual()
{
...
void Foam::adaptiveMultiscaleNeoHookeanElasticMisesPlastic::updateTotalFields()
{
...
Foam::scalar Foam::adaptiveMultiscaleNeoHookeanElasticMisesPlastic::newDeltaT()
{
