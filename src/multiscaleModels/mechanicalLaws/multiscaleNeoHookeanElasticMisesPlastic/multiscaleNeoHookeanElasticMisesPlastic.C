...
#include "multiscaleNeoHookeanElasticMisesPlastic.H"
...
namespace Foam
{
    defineTypeNameAndDebug(multiscaleNeoHookeanElasticMisesPlastic, 0);
    addToRunTimeSelectionTable
    (
        mechanicalLaw, multiscaleNeoHookeanElasticMisesPlastic, nonLinGeomMechLaw
    );

// * * * * * * * * * * * * * * Static Members  * * * * * * * * * * * * * * * //

    // Tolerance for Newton loop
    scalar multiscaleNeoHookeanElasticMisesPlastic::LoopTol_ = 1e-8;

    // Maximum number of iterations for Newton loop
    label multiscaleNeoHookeanElasticMisesPlastic::MaxNewtonIter_ = 200;

    // finiteDiff is the delta for finite difference differentiation
    scalar multiscaleNeoHookeanElasticMisesPlastic::finiteDiff_ = 0.25e-6;

    // Store sqrt(2/3) as we use it often
    scalar multiscaleNeoHookeanElasticMisesPlastic::sqrtTwoOverThree_ = ::sqrt(2.0/3.0);
...
void Foam::multiscaleNeoHookeanElasticMisesPlastic::makeRelF()
{
    if (relFPtr_)
    {
        FatalErrorIn("void Foam::multiscaleNeoHookeanElasticMisesPlastic::makeRelF()")
...
Foam::volTensorField& Foam::multiscaleNeoHookeanElasticMisesPlastic::relF()
{
    if (!relFPtr_)
    {
        makeRelF();
...
void Foam::multiscaleNeoHookeanElasticMisesPlastic::makeRelFf()
{
    if (relFfPtr_)
    {
...
Foam::surfaceTensorField& Foam::multiscaleNeoHookeanElasticMisesPlastic::relFf()
{
    if (!relFfPtr_)
    {
        makeRelFf();
...
void Foam::multiscaleNeoHookeanElasticMisesPlastic::makeJ()
{
    if (JPtr_)
    {
        FatalErrorIn("void Foam::multiscaleNeoHookeanElasticMisesPlastic::makeJ()")
            << "pointer already set" << abort(FatalError);
    }
...
Foam::volScalarField& Foam::multiscaleNeoHookeanElasticMisesPlastic::J()
{
    if (!JPtr_)
    {
        makeJ();
...
void Foam::multiscaleNeoHookeanElasticMisesPlastic::makeJf()
{
    if (JfPtr_)
    {
        FatalErrorIn("void Foam::multiscaleNeoHookeanElasticMisesPlastic::makeJf()")
            << "pointer already set" << abort(FatalError);
    }
...
Foam::surfaceScalarField& Foam::multiscaleNeoHookeanElasticMisesPlastic::Jf()
{
    if (!JfPtr_)
    {
        makeJf();
...
void Foam::multiscaleNeoHookeanElasticMisesPlastic::makeF()
{
    if (FPtr_)
    {
        FatalErrorIn("void Foam::multiscaleNeoHookeanElasticMisesPlastic::makeF()")
            << "pointer already set" << abort(FatalError);
    }
...
Foam::volTensorField& Foam::multiscaleNeoHookeanElasticMisesPlastic::F()
{
    if (!FPtr_)
    {
        makeF();
...
void Foam::multiscaleNeoHookeanElasticMisesPlastic::makeFf()
{
    if (FfPtr_)
    {
        FatalErrorIn("void Foam::multiscaleNeoHookeanElasticMisesPlastic::makeFf()")
            << "pointer already set" << abort(FatalError);
    }
...
Foam::surfaceTensorField& Foam::multiscaleNeoHookeanElasticMisesPlastic::Ff()
{
    if (!FfPtr_)
    {
        makeFf();
...
Foam::scalar Foam::multiscaleNeoHookeanElasticMisesPlastic::curYieldStress
(
...
Foam::scalar Foam::multiscaleNeoHookeanElasticMisesPlastic::yieldFunction
(
...
void Foam::multiscaleNeoHookeanElasticMisesPlastic::newtonLoop
(
...
) const
{
    ...
    do
    {
        ...
        if (i == MaxNewtonIter_)
        {
            WarningIn("multiscaleNeoHookeanElasticMisesPlastic::newtonLoop()")
...
Foam::tmp<Foam::volScalarField> Foam::multiscaleNeoHookeanElasticMisesPlastic::Ibar
(
...
Foam::tmp<Foam::surfaceScalarField> Foam::multiscaleNeoHookeanElasticMisesPlastic::Ibar
(
...
Foam::multiscaleNeoHookeanElasticMisesPlastic::multiscaleNeoHookeanElasticMisesPlastic
(
    const word& name,
    const fvMesh& mesh,
...
Foam::tmp<Foam::volScalarField> Foam::multiscaleNeoHookeanElasticMisesPlastic::rho() const
{
...
Foam::multiscaleNeoHookeanElasticMisesPlastic::impK() const
{
...
void Foam::multiscaleNeoHookeanElasticMisesPlastic::correct(volSymmTensorField& sigma)
{
...
void Foam::multiscaleNeoHookeanElasticMisesPlastic::correct(surfaceSymmTensorField& sigma)
{
    // Check if the mathematical model is in total or updated Lagrangian form
    if (nonLinGeom() == nonLinearGeometry::UPDATED_LAGRANGIAN)
    {
...
Foam::scalar Foam::multiscaleNeoHookeanElasticMisesPlastic::residual()
{
...
void Foam::multiscaleNeoHookeanElasticMisesPlastic::updateTotalFields()
{
...
Foam::scalar Foam::multiscaleNeoHookeanElasticMisesPlastic::newDeltaT()
{
